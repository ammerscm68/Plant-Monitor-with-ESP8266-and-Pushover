...
if (!IsNumeric(AlarmMessageSoilValue)) {saWMalarmsoilvalueInt = 30;} else {saWMalarmsoilvalueInt = AlarmMessageSoilValue.toInt();} // Prüfen ob Alarm Measure eine Zahl ist
