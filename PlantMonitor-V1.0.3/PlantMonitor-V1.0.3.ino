...
void loop()
{
  ...
  if  (String(h)+":"+String(m)+":"+String(s) == "4:0:0") {
  if (IsPushover == true && !SoilCalibrate) {
  if (PushoverDevice1 != "kA" && PushoverDevice1 != ""){  
  SendPushoverMessage("Der Sensor wird neu gestartet",PushoverDevice1,PushoverMessageSound);} // Message to Device 1
  if (PushoverDevice2 != "kA" && PushoverDevice2 != ""){  
  SendPushoverMessage("Der Sensor wird neu gestartet",PushoverDevice2,PushoverMessageSound);} // Message to Device 2
  if (PushoverDevice3 != "kA" && PushoverDevice3 != ""){  
  SendPushoverMessage("Der Sensor wird neu gestartet",PushoverDevice3,PushoverMessageSound);}} // Message to Device 3
  TimeRestart = true;
  }; 
  // #################################################################################################################
